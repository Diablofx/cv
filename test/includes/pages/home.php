<div class="row fullWidth"> 
	<div class="large-6 medium-6 small-12 columns" id="photo">
	...
	<div class="large-6 medium-6 small-12 columns" id="presentation">
		<p class="welcome">
	...
	<div class="large-6 medium-12 small-12 columns bubules">
		<div class="boutons">
			<div class="large-4 medium-4 small-4 columns rond bleu">
				<a class="block" href="formation">Formation</a>
			</div>

			<div class="large-4 medium-4 small-4 columns rond rose">										
				<a class="block" href="competences">Compétences</a>											
			</div>

			<div class="large-4 medium-4 small-4 columns rond vert">										
				<a class="block" href="experience">Expériences</a>
			</div>
		</div>
	</div>

	<div class="large-6 medium-6 small-12 columns bubulesmobile">
			<div class="row">
				<ul>
...
<div class="row nopadding">
	<div class="large-12 medium-12 small-12 columns" id="texthome">
